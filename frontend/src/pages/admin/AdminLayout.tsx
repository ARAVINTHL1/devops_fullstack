...
import {
  LayoutDashboard, Package, ShoppingCart, Warehouse, Users, TruckIcon,
  Brain, BarChart3, LogOut, Factory, ChevronLeft, ChevronRight, MessageSquare, Sparkles, AlertTriangle
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "Low Stock Alerts", path: "/admin/alerts", icon: AlertTriangle },
  { label: "Suppliers", path: "/admin/suppliers", icon: TruckIcon },
  { label: "ML Insights", path: "/admin/ml-insights", icon: Brain },
...
const AdminLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      <aside
        className={cn(
          "sidebar-gradient h-screen flex flex-col transition-all duration-300 sticky top-0",
      ...
      >
        ...
        <div className="border-t border-sidebar-border p-3">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={logout}
              className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-xs text-sidebar-foreground/70 hover:text-destructive hover:bg-sidebar-accent/50 transition-colors"
            >
            ...
            <button
              ...
              className="p-2 rounded-lg text-sidebar-foreground/70 hover:text-sidebar-accent-foreground hover:bg-sidebar-accent/50 transition-colors"
            >
